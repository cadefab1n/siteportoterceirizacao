...
const Logo = ({ className = "", invert = false }: { className?: string; invert?: boolean }) => (
  <div className={`flex-shrink-0 items-center flex gap-3 ${className}`}>
    <img 
      ...
      className={`h-11 md:h-14 w-auto transition-all duration-300 hover:scale-102 ${invert ? "brightness-0 invert" : ""}`}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-4">
                  <div className="aspect-[4/5] rounded-2xl overflow-hidden shadow-md">
                    <img src="/IMG_5479.jpg" alt="Rigor Operacional" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
                  </div>
